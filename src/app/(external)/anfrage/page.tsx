...
export default function AnfragePage() {
  ...
  async function submit() {
    ...
    try {
      ...
      if (!res.ok || !json?.ok) {
        alert("Fehler: " + (json?.error || `HTTP \${res.status}`))
        setLoading(false)
        return
      }
      ...
      >
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(to bottom, rgba(0,0,0,0.20), rgba(0,0,0,0.50), #07070a)",
            }}
          />
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "radial-gradient(circle at 20% 10%, rgba(220, 38, 38, 0.12), transparent 55%)",
            }}
          />
          <div
            style={{
              ...
              bottom: 0,
              height: "55%",
              background: "linear-gradient(to top, #07070a, rgba(7,7,10,0.50), transparent)",
            }}
          />
        </div>
        ...
        >
          ...
          <h1 style={{ marginTop: "24px", fontSize: "48px", fontWeight: "700", lineHeight: 1.15, letterSpacing: "-0.02em" }}>
            Dein Fahrzeug wartet –{" "}
            <span
              style={{
                background: "linear-gradient(90deg, #dc2626 0%, #f43f5e 45%, #f97316 100%)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
              <div
                style={{
                  ...
                  height: "32px",
                  borderRadius: "50%",
                  background: step >= 1 ? "#dc2626" : "rgba(255,255,255,0.10)",
                  color: "white",
                  fontWeight: 700,
                  fontSize: 14,
                }}
              ...
              <div
                style={{
                  ...
                  height: "32px",
                  borderRadius: "50%",
                  background: step >= 2 ? "#dc2626" : "rgba(255,255,255,0.10)",
                  color: "white",
                  fontWeight: 700,
                  fontSize: 14,
                }}
                  ...
                  <div style={{ display: "flex", gap: "12px", justifyContent: "space-between", marginTop: "12px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 600,
                        background:
                          name && email && phone && !loading ? "#dc2626" : "rgba(255,255,255,0.10)",
                        color: "white",
                        border: "none",
                        borderRadius: "8px",

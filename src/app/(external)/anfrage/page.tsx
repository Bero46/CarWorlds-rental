        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0.20), rgba(0,0,0,0.50), #07070a)",
            }}
          />
          <div
            style={{
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", marginTop: "-80px", position: "relative", zIndex: 10 }}>
          <div style={{ background: "rgba(0, 0, 0, 0.70)", border: "1px solid rgba(255, 255, 255, 0.16)", backdropFilter: "blur(24px)", borderRadius: "28px", padding: "32px", boxShadow: "0 20px 60px rgba(0, 0, 0, 0.60)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "32px", height: "32px", borderRadius: "50%", background: step >= 1 ? "#dc2626" : "rgba(255,255,255,0.10)", color: "white", fontWeight: 700, fontSize: 14 }}>
                1
              </div>
              <div style={{ flex: 1, height: "2px", background: step >= 2 ? "#dc2626" : "rgba(255,255,255,0.10)" }} />
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "32px", height: "32px", borderRadius: "50%", background: step >= 2 ? "#dc2626" : "rgba(255,255,255,0.10)", color: "white", fontWeight: 700, fontSize: 14 }}>
                2
              </div>
            </div>
            ...
            {step === 1 ? (
              <>
                ...
                <div style={{ display: "grid", gap: "16px" }}>
                  <div>
                    <label style={{ display: "block", fontSize: "12px", fontWeight: 600, color: "rgba(255,255,255,0.70)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px" }}>
                      Fahrzeug
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder="z.B. BMW M4 Competition"
                      style={{
                        width: "100%",
                        padding: "12px 14px",
                        borderRadius: "12px",
                      ...
                      onFocus={(e) => { e.currentTarget.style.background = "rgba(255,255,255,0.12)"; e.currentTarget.style.borderColor = "rgba(220,38,38,0.35)" }}
                      onBlur={(e) => { e.currentTarget.style.background = "rgba(255,255,255,0.08)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.15)" }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="z.B. Abholung morgens, Event am Samstag, ..."
                      style={{
                        width: "100%",
                        padding: "12px 14px",
                        borderRadius: "12px",
                  ...
                  <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end", marginTop: "12px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontSize: "14px",
                        fontWeight: 600,
                        background: step1Valid ? "#dc2626" : "rgba(255,255,255,0.10)",
                        color: "white",
                        border: "none",
                        borderRadius: "8px",
                      ...
                      onMouseEnter={(e) => { if (step1Valid) { e.currentTarget.style.background = "#b91c1c"; e.currentTarget.style.transform = "translateY(-2px)" } }}
                      onMouseLeave={(e) => { if (step1Valid) { e.currentTarget.style.background = "#dc2626"; e.currentTarget.style.transform = "translateY(0)" } }}
                    >
                  ...
                  <div style={{ display: "flex", gap: "12px", justifyContent: "space-between", marginTop: "12px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontSize: "14px",
                        fontWeight: 600,
                        background: name && email && phone && !loading ? "#dc2626" : "rgba(255,255,255,0.10)",
                        color: "white",
                        border: "none",
                        borderRadius: "8px",
                        cursor: name && email && phone && !loading ? "pointer" : "not-allowed",
                        transition: "all 200ms ease",
                        opacity: name && email && phone && !loading ? 1 : 0.5,
                      }}
                      onMouseEnter={(e) => { if (name && email && phone && !loading) { e.currentTarget.style.background = "#b91c1c"; e.currentTarget.style.transform = "translateY(-2px)" } }}
                      onMouseLeave={(e) => { if (name && email && phone && !loading) { e.currentTarget.style.background = "#dc2626"; e.currentTarget.style.transform = "translateY(0)" } }}
                    >
